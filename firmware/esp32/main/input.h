...
typedef enum {
  ...
  LM_CTRL_EVENT_OPEN_BACKFLUSH,
  LM_CTRL_EVENT_CLOSE_BACKFLUSH,
  LM_CTRL_EVENT_START_BACKFLUSH,
  LM_CTRL_EVENT_CONFIRM_VALUE,
  LM_CTRL_EVENT_OPEN_SETTINGS,
  LM_CTRL_EVENT_CONNECT_MACHINE,
  LM_CTRL_EVENT_OPEN_BREW_TIMER,
  LM_CTRL_EVENT_CLOSE_BREW_TIMER,
  LM_CTRL_EVENT_TOGGLE_BREW_TIMER_RUN,
  LM_CTRL_EVENT_RESET_BREW_TIMER,
